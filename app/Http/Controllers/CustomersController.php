...
public function autocomplete(Request $request)
{
    ...
    // Use 'contact_number' since that's what your database has
    $customers = Customers::where('contact_number', 'LIKE', '%' . $term . '%')->get();

    return response()->json($customers->map(function ($customer) {
        return [
            'id'    => $customer->id,
            'name'  => $customer->customer_name,
            'phone' => $customer->contact_number, // Ensure you're using contact_number
        ];
    }));
}
