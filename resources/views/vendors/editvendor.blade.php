<x-layout> 
    <x-pagestructure>
        ...
        <div class="flex justify-end">
            ...
            <form class="grid gap-5 items-center p-3" method='POST' action="/update-vendor">
                ...
                <div class="grid md:grid-cols-6 md:gap-2 items-center">
                    ...
                    <input type="text" name="vendor_name" id="vendor_name" placeholder="Enter vendor name"
                        class="p-2 border border-gray-300 bg-white rounded-md md:col-span-4 lg:col-span-2" value='{{$vendordata->vendor_name}}'/>
                </div>
                ...
                <div class="grid md:grid-cols-6 md:gap-2 items-center">
                    ...
                    <input type="text" name="contact_person" id="contact_person" placeholder="Enter contact person name"
                        class="p-2 border border-gray-300 bg-white rounded-md md:col-span-4 lg:col-span-2" value='{{$vendordata->contact_person}}'/>
                </div>
                ...
                <div class="grid md:grid-cols-6 md:gap-2 items-center">
                    ...
                    <input type="text" name="address" id="address" placeholder="Enter address"
                        class="p-2 border border-gray-300 bg-white rounded-md md:col-span-4 lg:col-span-2" value='{{$vendordata->address}}'/>
                </div>
                ...
                <div class="grid md:grid-cols-6 md:gap-2 items-center">
                    ...
                    <input type="text" name="phone" id="phone" placeholder="Enter contact number"
                        class="p-2 border border-gray-300 bg-white rounded-md md:col-span-4 lg:col-span-2" value='{{$vendordata->phone}}'/>
                </div>
            ...
            <div class="grid md:grid-cols-6 md:gap-2 items-center">
                ...
                <input type="checkbox" name="is_gst" id="is_gst" class="h-4 w-4 text-blue-600 border-gray-300 rounded" {{ $vendordata->is_gst ? 'checked' : '' }}/>

                </div>
                <input type="text" name="gst_number" placeholder="Enter GST number"
                    class="p-2 border border-gray-300 bg-white rounded-md md:col-span-4 lg:col-span-2"  value="{{ $vendordata->gst_number }}" {{ $vendordata->is_gst ? '' : 'readonly' }}/>
            </div>
                ...
                <div class="grid md:grid-cols-6 md:gap-2 items-center">
                    ...
                    <input type="text" name="description" id="description" placeholder="Enter description (optional)"
                        class="p-2 border border-gray-300 bg-white rounded-md md:col-span-4 lg:col-span-2" value='{{$vendordata->description}}'/>
                </div>
