  ...
  <x-pagestructure>
      <div class="flex flex-1 flex-col gap-4 p-4">
          ...
          <div class="flex justify-end">
              <form method='POST' action="/delete-business-invoice">
                  @csrf
                  @method('DELETE')
              ...
              <div class="flex justify-end ">
                <a href="/b2b-invoice" class="inline-block bg-[#062242]  text-white font-semibold py-2 px-4 rounded-lg shadow-sm transition duration-200">
                    ← Back
                </a>
            </div>
          </div>
          ...
          <form action="/update-business-invoice" method="POST" class="bg-white p-6 rounded-lg shadow-md">
              @csrf
              @method('PUT')
              <h2 class="text-xl font-semibold text-gray-700 mb-4">Business Invoice</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input type="date" id="invoice_date" name="invoice_date"
              class="w-full p-2 border border-gray-300 bg-white rounded-md" required value="{{$invoice->invoice_date}}">
          </div>
          ...
          <div>
            ...
            <input type="text" id="invoice_number" name="invoice_number" placeholder="Enter invoice number"
              class="w-full p-2 border border-gray-300 bg-white rounded-md" required value="{{$invoice->invoice_number}}">
          </div>
          ...
          <!-- Customer Name -->
        <div>
          <label for="customer_id" class="block text-sm font-medium text-gray-600">
              <span class="font-bold underline">C</span>ustomer Name
          </label>
          ...
          <div>
            <label for="customer_gst" class="block text-sm font-medium text-gray-600">Customer GST</label>
            <input name="customer_gst" placeholder="Customer GST" id="gst_number" 
            class="w-full p-2 border border-gray-300 bg-white rounded-md"  value="{{$customers->where('id', $invoice->customer_id)->first()->gst_number}}" readonly>
          </div>
        ...
        <div class="w-full mt-6">
          ...
          @php
            $itemsDetails = json_decode($invoice->item_details, true);
          @endphp
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-5">
          ...
          <div>
           ...
           <div id="paid_amount_div">
             ...
             <input type="number" name="paid_amount" id="paid_amount" step="0.01" value="{{$invoice->paid_amount}}" class="w-full p-2 border border-gray-300 bg-white rounded-md" oninput="updateBalance()" />
           </div>
            ...
            <div class="mt-2 flex items-center gap-2">
              ...
              <label for="return_change" class="text-sm text-gray-600">Returned change to customer</label>
                       ...
                       <div>
                        ...
                        <input type="number" name="discount_percent" id="discount_percent" step="1"  max="100" value="{{ old('discount_percent', $invoice->discount_percent ) }}"
        ...
        <div class="mt-6 w-full">
          ...
          <textarea name="description" id="description" rows="3"
              class="p-2 w-full border border-gray-300 bg-white rounded-md focus:ring-blue-500 focus:border-blue-500">{{ old('description', $invoice->description) }}</textarea>
      </div>
...
function gstTypeOnload(){
        let getFirstTwoletter = $('#gst_number').val().substring(0, 2);
        var admingstTwoletter = $('#admin_gst').text();
        let clientGst = getFirstTwoletter.substring(0, 2);
        let adminGst = admingstTwoletter.substring(0, 2);
