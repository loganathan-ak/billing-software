    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <div class="flex items-center gap-x-3">
                <h2 class="text-lg font-medium text-gray-800 dark:text-white">Sales Invoice</h2>
        ...
        <div class="flex items-center mt-4 gap-x-3">
            ...
            <a href="/add-invoice" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
            ...
            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900" id="sales-table-body">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        <p class="text-gray-500 dark:text-gray-400">{{$invoice->customer_name}}</p>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <a href="/view-invoice/{{$invoice->id}}" class="px-1 py-1 text-blue-500 font-medium transition-colors duration-200 rounded-lg dark:text-gray-300 hover:bg-gray-100">
                                        View
                                    </a>
                                    <a href="/edit-invoice/{{$invoice->id}}" class="px-3 font-medium py-1 text-blue-500 transition-colors duration-200 rounded-lg dark:text-gray-300 hover:bg-gray-100">
                                       Edit
                                    </a>
                                </td>
                            </tr>
